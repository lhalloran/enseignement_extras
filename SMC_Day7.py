...
Part of the 26.10.2021 lecture in courses:
Scientific Method and Communication 
and
Literature review, scientific writing and master project proposal
...
Conc1 = Conc1 + np.random.normal(loc=0.00,scale=0.2,size=nval)
#%% MAKE BAD FIG (bar)
